...
.img-container {
	height: 500px;
	width: 100%;
	background-image: url("Images/NormalRoom1.jpg");
...
.img-containers .img-container:nth-child(2) {
	background-image: url("Images/NormalRoom2.jpg");
}

.img-containers .img-container:nth-child(3) {
	background-image: url("Images/NormalRoom3.jpg");
}
...
<body>
	...
	<div class="alert alert-danger alert-dismissible fade show"
		...
		<button type="button" class="btn-close" data-bs-dismiss="alert"
			aria-label="Close" id="btn"></button>
	</div>
		...
		<div class="input-container">
			...
			<form action="room_func" method="post">
				...
				<label>Number Of Rooms : </label> <input type="number"
					name="NoRooms" id="NoRooms" value="1" min="1" required="required">

				<label>Check-In : </label> <input type="date" id="CheckIn"
					name="CheckIn" required="required"> <label>Check-Out
					: </label> <input type="date" id="CheckOut" name="CheckOut"
					required="required"> <input type="hidden" name="room"
					value="Normal"> <a href="RoomCheckOut.jsp"><input
					type="submit" name="submit" id="BookRoom" value="Check Out"></a>
	...
	<script>
		...
		document.getElementById('CheckIn').addEventListener(
				'change',
				function() {
					...
					document.getElementById('CheckOut').setAttribute('min',
							minCheckOut);
				});
		...
		function updatePrice() {
			...
			let TotalPRice = 2000 * noRooms;
			let price = document.getElementById("price");
			price.innerHTML = "Total Price : " + TotalPRice;
		}
		document.getElementById("NoRooms").addEventListener("input",
				updatePrice);
		updatePrice();
	</script>
</body>
